  ...
  properties: {
    ...
    expectation: {
      ...
      properties: {
        ...
        atMostDays: { type: "number", description: "Only when the text caps a duration in days ('30 days or less', 'no more than 90 days')." },
      },
      required: ["fieldHint"],
    },
  },

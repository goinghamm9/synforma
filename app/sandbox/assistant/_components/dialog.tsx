...
export interface LumenDialogProps {
  open: boolean;
...
export function LumenDialog({ open, onOpenChange, title, description, children, footer, requireAction, className }: LumenDialogProps) {
  return (
